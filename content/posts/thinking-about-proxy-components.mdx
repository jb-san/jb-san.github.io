...
I think there is a point on always importing all components from `components/*`, so if you have an Input from `material-ui` you should create a **Proxy component** that you then use in you app.
